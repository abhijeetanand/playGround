///header			
app_global_context["registerFunc"]("", test_case_parent_thread_37, "basic");
////function follows			
function test_case_parent_thread_37() {
    //importScripts() - multiple files;
    kony.print("Parent Scope: Init test_case_parent_thread()");
    //create new kony.worker.WorkerThread
    var worker = new kony.worker.WorkerThread('TestCase037WorkerThread.js');
    //global
    _jsonOBJ = {
