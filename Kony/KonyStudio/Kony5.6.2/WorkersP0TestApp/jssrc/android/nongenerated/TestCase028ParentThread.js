///header			
app_global_context["registerFunc"]("", test_case_parent_thread_28, "basic");
////function follows			
function test_case_parent_thread_28() {
    //importScripts() - file not present ;
    kony.print("Parent Scope: Init test_case_parent_thread()");
    //create new kony.worker.WorkerThread
    var worker = new kony.worker.WorkerThread('TestCase028WorkerThread.js');
