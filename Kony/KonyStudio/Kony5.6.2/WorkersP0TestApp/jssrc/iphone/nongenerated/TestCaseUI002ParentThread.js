///header			
app_global_context["registerFunc"]("UI - 2", test_case_ui_parent_thread_2, "nonui");
////function follows			
function test_case_ui_parent_thread_2() {
    //2) 
    try {
        kony.print("Parent Scope: Init test_case_parent_thread()");
        kony.print("Parent Scope: In try block");
        //create new kony.worker.WorkerThread
        var worker = new kony.worker.WorkerThread('TestCaseUI002WorkerThread.js');
