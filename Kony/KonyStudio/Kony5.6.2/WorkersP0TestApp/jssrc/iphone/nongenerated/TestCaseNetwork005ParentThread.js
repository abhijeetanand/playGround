///header			
app_global_context["registerFunc"]("konynetwork API - kony.net.HttpRequest()", test_case_network_parent_thread_5, "nonui");
////function follows			
function test_case_network_parent_thread_5() {
    //5) 
    try {
        kony.print("Parent Scope: Init test_case_parent_thread()");
        kony.print("Parent Scope: In try block");
        //create new kony.worker.WorkerThread
        var worker = new kony.worker.WorkerThread('TestCaseNetwork005WorkerThread.js');
