///header			
app_global_context["registerFunc"]("UI - 1", test_case_ui_parent_thread_1, "nonui");
////function follows			
function test_case_ui_parent_thread_1() {
    //1) 
    try {
        kony.print("Parent Scope: Init test_case_parent_thread()");
        kony.print("Parent Scope: In try block");
        //create new kony.worker.WorkerThread
        var worker = new kony.worker.WorkerThread('TestCaseUI001WorkerThread.js');
