define("checkoutDependent",
        ["cartDependent", "inventoryDependent"],
        function(cartDependent, inventoryDependent) {
            ...
            return {"checkoutDependent":"checkout object"};
       }
);

require(["checkoutDependent"], 
		function(checkoutDependent){
