...
function addWidgetsfrm3() {
    ...
    var label115052332257161 = new kony.ui.Label({
        "id": "label115052332257161",
        "isVisible": true,
    ...
    var CustomButtoncustom115052332257162 = new com.kony.customwidget.CustomButton({
        "id": "CustomButtoncustom115052332257162",
        "image": null,
        "isVisible": true,
        "hExpand": true,
        "vExpand": false,
    ...
    frm3.add(
    label115058290429423, button115058290429430, label115052332257161, CustomButtoncustom115052332257162);
};
...
function frm3Globals() {
    ...
    frm3 = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["label115058290429423", "button115058290429430", "label115052332257161", "CustomButtoncustom115052332257162"]
    });
};