...
function callAppMenu() {
    var appMenu = [
        ["appmenu68508508644653", "Home", null, appmenu68508508644653_callback_seq0]
    ];
    kony.application.createAppMenu("FMNegativeAppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("FMNegativeAppMenu");
}