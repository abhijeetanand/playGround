...
function kony(){ 
	...
	function Form2 (basicProperties, layoutProperties, platformSpecificProperties){
		...
		*/
		...
		/**
		 * Specifies the color for progress indicator when it is being shown on the form. 
		 * @property {String}
		 * @Available iOS and Android Platforms
		 * @access Read and Write
		 */
		...
		/**
		 * Enables the scrolling of the form when containerHeight is given to the Form.
		 * @property {Boolean}
		...
		/**
		 * Specifies the form content to scroll under the App Menu. This property is supported in iOS7 and above only. This property is also applicable on the Application Level properties under Application Properties > Native > iPhone/iPad > Platform Settings. The property set at Form level takes precedence over Application level. 
		 * @property {Boolean}
		 * @Available Available on iOS platform.
		 * @access Read and Write
		 */
		...
		/**
		 * This property enables you to set the status bar style. The options are constants.STATUS_BAR_STYLE_DEFAULT or constants.STATUS_BAR_STYLE_LIGHT_CONTENT.  
		 * @property {String}
		 * @Available Available on iOS platform.
		 * @access Read and Write
		 */
		 ...
		 * @usage <pre>	
	     */
		this.setTitleBarLeftSideButtonSkin = function (/**String*/text,/**string*/skin,/**Object*/callBack)	{}
		 ...
		 * @usage <pre>	
	     */
		this.setTitleBarRightSideButtonSkin = function (/**String*/text,/**string*/skin,/**Object*/callBack) {}
	...
	function ComboBox(basicProperties, layoutProperties, platformSpecificProperties){
		...
		*/
		...
		/**
		 * Specifies the background color for the wheel that is displayed when you click the ComboBox. This property is applicable only when you set the viewType as COMBOBOX_VIEW_TYPE_ONSCREENWHEEL.
		 * @property {Boolean}
		 * @Available iOS
		 * @access Read and Write
		 */
		this.wheelBackgroundColor = true
	...
	function RadioButtonGroup(basicProperties, layoutProperties, platformSpecificProperties){
		...
		*/
		...
		/**
		 * Specifies the background color for the wheel that is displayed when you click the RadioButton. This property is applicable only when you set the viewType as RADIOGROUP_VIEW_TYPE_ONSCREENWHEEL.
		 * @property {Boolean}
		 * @Available iOS
		 * @access Read and Write
		 */
	...
	function CheckBoxGroup (basicProperties, layoutProperties, platformSpecificProperties){
		...
		*/
		...
		/**
		 * Specifies the background color for the wheel that is displayed when you click the CheckBox. This property is applicable only when you set the viewType as CHECKBOX_VIEW_TYPE_ONSCREENWHEEL.
		 * @property {Boolean}
		 * @Available iOS
		 * @access Read and Write
		 */
	...
	function Map(basicProperties, layoutProperties, platformSpecificProperties){
		...
		/**
		 * Specifies the reference for the height of the container based on option that you set for containerHeight. The container height percentage is calculated based on eigher CONTAINER_HEIGHT_BY_FORM_REFERENCE or CONTAINER_HEIGHT_BY_PARENT_WIDTH.
		 * @property {Number}
		 * @Available Available on all platforms except on all Server side Mobile Web and Desktop Web platforms.
		 * @access Read and Write
		 */
	...
	function Popup(basicProperties, layoutProperties, platformSpecificProperties){
		...
		*/
		...
		/**
		 * Enables the scrolling of the form when containerHeight is given to the popup.
		 * @property {Boolean}
		 * @Available Available on all platforms excelt Server side Mobile Web and Desktop Web platforms.
		 * @access Read and Write
		 */
		...
		/**
		 * Specifies the popup content to scroll under the App Menu. This property is supported in iOS7 and above only. This property is also applicable on the Application Level properties under Application Properties > Native > iPhone/iPad > Platform Settings. The property set at Form level takes precedence over Application level. 
		 * @property {Boolean}
		 * @Available Available on iOS platform.
		 * @access Read and Write
		 */
	...
	function ScrollBox (basicProperties, layoutProperties, platformSpecificProperties){
		...
		*/
		...
		/**
		 * Enables the scrolling of the form when containerHeight is given to the ScrollBox.
		 * @property {Boolean}
		 * @Available Available on all platforms excelt Server side Mobile Web and Desktop Web platforms.
		 * @access Read and Write
		 */
	...
	function SegmentedUI2(basicProperties, layoutProperties, platformSpecificProperties){
		...
		/**
		 * Specifies the height of the SegmentedUI in terms of percentage. The percentage is with reference to the value of containerHeightReference property. This property is applicable only when the viewType is set as SEGUI_VIEW_TYPE_TABLEVIEW or SEGUI_VIEW_TYPE_PAGEVIEW.
		 * @property {Number}
		 * @Available Available on all platforms except on all Server side Mobile Web and Desktop Web platforms.
		 * @access Read and Write
		 */
	...
	function TextArea2(basicProperties, layoutProperties, platformSpecificProperties){
		...
		*/
		...
		/**
		 * Specifies the alignment of the text and placeholder text for a TextArea with respect to its boundaries.
		 * @property {Number}
		 * @Available All Platforms except Server side Mobile Web
		 * @access Read and Write
		 */
	...
	function TextBox2(basicProperties, layoutProperties, platformSpecificProperties){
		...
		*/
		...
		//TextBox2 - Layout Configuration Properties starts here
		  ...
		  /**
		   * Specifies the accessiblity configuration property for clear button.
		   * @property {Object}
		  ...
		  */
		this.accessibilityConfigForClearButton = {}
	...
	function TabPane(basicProperties, layoutProperties, platformSpecificProperties){
		...
		this.addTabAt = function(/**String*/tabId,/**String*/tabName,/**String*/tabImage,/**Object*/box,/**Number*/index) {}
...
menu1.setDataAt ( {template: hbox2,
	...
	*/
	...
	//Added for 5.6.2 Release. 
	//This is how Background Jobs APIs are defined
	kony.backgroundjob.
	...
	* @param backgroundCallBack{Function} This callback is to be executed when the system invokes the app for a fetch job when the app is in background. <b>Mandatory</b>
	* @param fetchInterval{Number} Indicates the minimum time interval in seconds which must elapse before system can invoke the app for next fetch job .This is an optional parameter and value that is specified is only indicative and might not have any real effects on the scheduling frequency, as system decides the actual interval.<b>Optional</b>
	* @Availability iOS Platform
	* @access Write
	* @usage  <pre>function backgroundFetchCallBack() {
...
var completionStatus = constants.BACKGROUND_TASK_STATUS_NEW_DATA;
	...
	registerBackgroundFetch (backgroundCallBack, fetchInterval) = function (/**Function*/backgroundCallBack,/**Number*/fetchInterval){
...
var completionStatus = constants.BACKGROUND_TASK_STATUS_NEW_DATA;
	...
	//register background fetch job
    kony.backgroundjob.registerBackgroundFetch(backgroundFecthCallBack, fetchInterval);</pre>*/
	setBackgroundFetchCompletionStatus(completionStatus) = function (/**Number*/completionStatus){
	...
	* @usage  <pre>//Fetch interval 
	...
	setBackgroundFetchInterval(fetchInterval) = function (/**Number*/fetchInterval){
	
	}

	//This is how WorkerThread APIs are defined
	kony.worker.
	...
	* @usage  <pre>try {
	...
	WorkerThread(workerjs) = function (/**string*/workerjs){
	
	}

	//hasWorkerThreadSupport
	kony.worker.
	/**hasWorkerThreadSupport() API can be used during runtime in Parent scope to determine whether the current platform environment has worker thread support.
	...
	* @Availability Available for iOS, Android, Windows, SPA, and Desktop Web
	* @access Write
	* @usage  <pre>var hasWorkerSupport = kony.worker.hasWorkerThreadSupport();
	...
	//postMessage
	/**postMessage() can be used to send a JSON object message or String message from Worker/Parent to Parent/Worker's scope by invoking respective registered “message” event handlers.
	* @param Parameter1{Object}String or JSON Object<b>Mandatory</b>
	* @Availability Available only on iOS.
	* @access Write
	* @usage  <pre>
	var worker = new kony.worker.WorkerThread(“worker1.js”);
...
//or
	...
	postMessage(<String> or <JSON>) = function (/**Object*/Parameter1){
	
	}
	
	//addEventListener
	worker.
	/**EventHandlers can be registered using addEventListener() method on the worker Objects and once registered messages and errors from a worker thread can be received in parent thread.
...
addEventListener(“message”, evtMessageHandler_1);
	...
	addEventListener(key, listener); = function (/***/key,/***/listener){
	
	}
	
	//message event handler
	function(event) {})
	/**Use this API to  receive an event object where event object contains the JSON object or string that is passed through postMessage() and can be accessed from event.data field.
	* @param String or JSON Object{Object}The data passed should be a String or JSON object.
The data that is passed between the parent thread and worker thread using postMessage() API are copied and not shared. So that the end result is that a duplicate is created on each end.
Multiple message event handlers can also be registered in parent scope and in workers inner scope and all the registered event handlers will be invoked in the registered order whenever a postMessage() is called.<b>Mandatory</b>
	* @Availability Available only on iOS.
	* @access Write
	* @usage  <pre>var evtMessageHandler_1 = function(event) {
//In case of JSON
kony.print (“Received message :” + event.data[“msg”]); 

//In case of string
kony.print (“Received message :” + event.data); 
};
</pre>*/
	function(event) { }); = function (/**Object*/String or JSON Object){
	
	}
	
	//message event handler
	function(event) {})
	/**Use this API to remove the previously registered “message” event listener,  which was registered using addEventListener().
This function can be used in both Parent and worker scope
	...
	* @usage  <pre>function(event) {
	...
	function(event) { }); = function (/***/event object (message, filename, lineno)){
	
	}
	
	//removeEventListener
	worker.
	/**removeEventListener() can be used to remove the previously registered “message” event listener or “error” event listener which was registered using addEventListener().
...
self.addEventListener("error", evtErrorHandler_2);
	...
	removeEventListener(key, listener); = function (/***/key or listener){
...
self.close();
	...
	//Importing scripts
	importScripts(“.
	/**This API is used to import external scripts and their scope by providing the JavaScript file name to import. This method takes one or more JavaScript file names to import.
...
importScripts(“Utility1.js”, “Utility2.js”, “Utility3.js”); </pre>*/
	js file name”) = function (/**Object*/JSFileNames ){
		...
		* @Usage <pre>function openMediaURL()
{
	...
	kony.application.openMediaURL("http://www.youtube.com/watch?v=_kKJ_Dmpa7o");
		...
		kony.application.
		/**This API enables you to set uniform behavior across platforms.User can set the loading indicator at application level. For this the following key value pairs needs to be passed to the API. 
		defaultIndicatorColor:"565656AA"
