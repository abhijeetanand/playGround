define("checkoutDependentTwo",
        ["cartDependentTwo", "inventoryDependentTwo"],
        function(cartDependentTwo, inventoryDependentTwo) {
        	try
        	{
            	...
            	return {"checkoutDependentTwo":"checkout object"};
            }
            catch(e)
            {
...
require(["checkoutDependentTwo"], 
		function(checkoutDependentTwo){
			try
			{
