		function test_case_sql_parent_thread_6() {
		    ...
		    try {
		        kony.print("Parent Scope: Init test_case_parent_thread_6()");
		        var worker = new kony.worker.WorkerThread('TestCaseSQL006WorkerThread.js');
		        timer_init();
		...
		function sql_producer_func() {
		    ...
		    function success_createTable(transactionId, resultset) {
		        kony.print("Parent Scope : sql_producer_func : success_createTable: Table Created from Worker");
		    }
