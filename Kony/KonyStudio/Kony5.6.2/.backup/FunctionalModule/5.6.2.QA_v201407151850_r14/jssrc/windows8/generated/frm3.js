...
function addWidgetsfrm3() {
    ...
    var CustomButtoncustom159024231271496 = new com.kony.customwidget.CustomButton({
        "id": "CustomButtoncustom159024231271496",
        "image": null,
        "isVisible": true,
        "hExpand": true,
        "vExpand": false,
    ...
    frm3.add(
    label115058290429423, button115058290429430, label115052332257165, CustomButtoncustom159024231271496);
};
...
function frm3Globals() {
    ...
    frm3 = new kony.ui.Form2({
        ...
        "titleBar": true,
        "showBackButton": true,
        "directChildrenIDs": ["label115058290429423", "button115058290429430", "label115052332257165", "CustomButtoncustom159024231271496"],
        "viewConfig": {
            "referenceHeight": 0,
            "referenceWidth": 0
        }
