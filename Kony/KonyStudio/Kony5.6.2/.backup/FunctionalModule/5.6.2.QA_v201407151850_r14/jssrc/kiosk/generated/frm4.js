...
function frm4_button115037436768703_onClick_seq0(eventobject) {
    frm4.lblFFI.text = FFIWin.add(11, 11);
};
...
function addWidgetsfrm4() {
    ...
    frm4.add(
    label115058290429434, hbox115058290429435, label115037436768788, button115037436768703, button115037436768707, richResult, lblFFI);
};
...
function frm4Globals() {
    ...
    frm4 = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["label115058290429434", "hbox115058290429435", "button115058290429436", "label115058290429437", "button115037436768703", "richResult", "button115037436768707", "label115037436768788", "lblFFI"]
    });
};