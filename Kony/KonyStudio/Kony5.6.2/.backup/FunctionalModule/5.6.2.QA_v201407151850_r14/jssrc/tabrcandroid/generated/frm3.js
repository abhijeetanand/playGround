...
function frm3_cust1custom159024231271495_slideCheck_seq0(l, h) {
    slidePrint.call(this, l, h);
};
...
function addWidgetsfrm3() {
    ...
    var cust1custom159024231271495 = new com.kny.cust1({
        "id": "cust1custom159024231271495",
        "image": null,
        "isVisible": true,
        "hExpand": true,
        "vExpand": false,
        "low": 0,
        "high": 100,
        "slideCheck": frm3_cust1custom159024231271495_slideCheck_seq0,
        "aInt": 111,
        "aLong": 222,
        "aFloat": 10.10,
        "aDouble": 20.20,
    ...
    frm3.add(
    label115058290429423, button115058290429430, label115052332257165, cust1custom159024231271495);
};
