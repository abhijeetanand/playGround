define("cartSameFileOne", function() {
    return {
        "cartSameFileOne": "Cart object"
    };
});
define("inventorySameFileOne", function() {
    return {
        "inventorySameFileOne": "Inventory object"
    };
});
require(["cartSameFileOne", "inventorySameFileOne"], function(cartSameFileOne, inventorySameFileOne) {
