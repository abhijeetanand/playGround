...
function addWidgetsfrm3() {
    ...
    var label159024231271490 = new kony.ui.Label({
        "id": "label159024231271490",
        "isVisible": true,
        "text": "Custom widget not supported on bb nth",
        "skin": "lblskn"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
    ...
    frm3.add(
    label115058290429423, button115058290429430, label115052332257165, label159024231271490);
};
