...
function appmiddlewareinvoker(inputParam, isBlocking, indicator, datasetID) {
    ...
    inputParam["platformver"] = "5.6.QA_v201407010002";
...
function callAppMenu() {
    var appMenu = [
        ["home", "home", "h.png", home_callback_seq0,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }],
        ["exit", "exit", "e.png", exit_callback_seq0,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }]
    ];
    kony.application.createAppMenu("FuncModAsyncAppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("FuncModAsyncAppMenu");
}