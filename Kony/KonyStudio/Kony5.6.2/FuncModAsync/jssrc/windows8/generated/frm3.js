...
function addWidgetsfrm3() {
    ...
    var CustomButtoncustom68508508643387 = new com.kony.customwidget.CustomButton({
        "id": "CustomButtoncustom68508508643387",
        "image": null,
        "isVisible": true,
        "hExpand": true,
        "vExpand": false,
    ...
    frm3.add(
    label115058290429423, button115058290429430, label115052332257165, CustomButtoncustom68508508643387);
};
...
function frm3Globals() {
    ...
    frm3 = new kony.ui.Form2({
        ...
        "titleBar": true,
        "showBackButton": true,
        "directChildrenIDs": ["label115058290429423", "button115058290429430", "label115052332257165", "CustomButtoncustom68508508643387"],
        "viewConfig": {
            "referenceHeight": 0,
            "referenceWidth": 0
        }
