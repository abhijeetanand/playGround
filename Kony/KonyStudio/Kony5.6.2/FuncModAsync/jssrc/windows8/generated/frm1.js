...
function addWidgetsfrm1() {
    var label115058290429415 = new kony.ui.Label({
        ...
        "isVisible": true,
        "text": "PQ-70715,PQ-70719,PQ-70730: This form is shown in the success call back of loadFunctionalModuleAsync",
        "skin": "lblskn"
    }, {
...
function frm1Globals() {
    ...
    frm1 = new kony.ui.Form2({
        ...
        "titleBar": true,
        "directChildrenIDs": ["label115058290429415", "segment2115058290429417"],
        "viewConfig": {
            "referenceHeight": 0,
            "referenceWidth": 0
        }
