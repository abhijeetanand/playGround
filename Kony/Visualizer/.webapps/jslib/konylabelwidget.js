...
$KW.Label =
{
    ...
    render: function(labelModel, context){
		...
		var cAlign = $KW.skins.getContentAlignment(labelModel);	
                var htmlString ="";
         htmlString = "<div" + $KW.Utils.getBaseHtml(labelModel, context)  + "class = '" + computedSkin + "' style='text-align:" + cAlign + ";" + $KW.skins.getMarginSkin(labelModel, context) + $KW.skins.getPaddingSkin(labelModel);
        ...
        htmlString += "><label  " + accessAttr + " style='white-space:pre-wrap;word-wrap:break-word;text-align:" + cAlign + ";'>" + labelModel.text + "</label></div>";            
        return htmlString;
    },
