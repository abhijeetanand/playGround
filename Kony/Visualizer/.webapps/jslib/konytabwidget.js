...
$KW.TabPane =
{
	...
	generateTabView: function(tabPaneModel,context,updateViewFlag){
        ...
        var css = (!tabPaneModel.isvisible) ? " hide " : "";
		...
		if(!updateViewFlag)
			htmlString += "<div id = '" + paneId + "' class='" + css + "' style='" + marginPadding + "' kformname='" + tabPaneModel.pf + "' kwidgettype='TabPane'>";		
	...
	generateCollapsibleView: function(tabPaneModel, context, updateViewFlag){
        ...
        if(!updateViewFlag)
			htmlString += "<div class='" + css + "' style='" + marginPadding + "' id = '" + tabPaneModel.pf + "_" + tabPaneModel.id + "' kformname='" + tabPaneModel.pf + "' kwidgettype='TabPane'>";
