...
$KW.Slider = {
    ...
    render: function(sliderModel, context){
        ...
        if(!sliderModel.isvisible) sliderrighttskin = sliderrighttskin+" hide";
		...
		{			
			htmlString += '<div' + " tabindex='0'" + 'style=" '+ $KW.skins.getMarginSkin(sliderModel, context)+'" class = "'+$KW.skins.getMarAdjustedContainerWeightSkin(sliderModel, 100)+' ">';
			...
			if(sliderModel.isvisible) {
					htmlString += '<div style="margin-top: 10px; min-height:25px;" >';
					htmlString += '<label style="float: left; "class="'+sliderModel.minlabelskin+'" >'+minlabeltext+'</label>';
					htmlString += '<label style="float: right; "class="'+sliderModel.maxlabelskin+'" >'+maxlabeltext+'</label>'
					htmlString += '</div>';
			}
			...
			htmlString += '<div style="margin: 5%; width:90%;">';
