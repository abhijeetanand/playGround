...
function containerWidgetExtendRemove(widgetref) {
	...
	if(this.wType == "ScrollBox") 
		boxWidgetExtendRemoveBoxWeight.call(this, widgetref,true);
};
...
function containerWidgetExtendRemoveAt(index) {
	...
	if(this.wType == "ScrollBox") 
		boxWidgetExtendRemoveBoxWeight.call(this, remwidgetref,true);
	return remwidgetref;
};
...
function containerWidgetExtendRemoveReferences(widgetref) {
	...
	if(this.wType==="Form"|| this.wType==="Popup")
		delete $KG.allforms[widgetref.pf][widgetref.id];	
};
...
function boxWidgetExtendRemoveBoxWeight(widgetarray,remove)
{
    this.totalWt =0;
...
function formWidgetExtendRemove(widgetref) {
	if(widgetref) {
		...
		updateFormWithScreenLevelWidget(this, widgetref);
	}
};
...
function updateFormWithScreenLevelWidget(formModel, widgetRef)
{
