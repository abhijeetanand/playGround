...
$KW.VBox =
{
    ...
    {		
		...
		var parentModel = kony.model.getWidgetModel(vBoxModel.pf, vBoxModel.parent);
       ...
       // var boxstyle = /*$KW.Utils.getNormalImageStyle(vBoxModel) + */ " table-layout:fixed;" + $KW.skins.getMarginSkin(vBoxModel, context) + $KW.skins.getPaddingSkin(vBoxModel);	
            var boxstyle = /* $KW.Utils.getNormalImageStyle(boxModel) + */ " table-layout:fixed;" + $KW.skins.getMarginSkin(vBoxModel, context) + $KW.skins.getPaddingSkin(vBoxModel);
        
		var visibleClass = (!$KW.Utils.isWidgetVisible(vBoxModel, context) ? " hide" : "");
        ...
        for (var i = 0; i < len; i++) {        
            ...
            //Do not need parentModel as we can access childModel by vBoxModel.childModel.id
            //var childModel = parentModel[vBoxModel.children[i]];
