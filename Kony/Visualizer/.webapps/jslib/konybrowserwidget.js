...
$KW.Browser = {
    ...
    render: function(browserModel, context){
        ...
        var computedSkin = $KW.skins.getWidgetSkinList(browserModel, context); 
            ...
            htmlString = "<div " +$KW.Utils.getBaseHtml(browserModel, context) + $KW.Utils.getBaseHtml(browserModel, context) + " class='" + computedSkin  + "' style='" + $KW.skins.getMarginSkin(browserModel, context) + $KW.skins.getPaddingSkin(browserModel) + "'>";
